...
function pinkWall() { if (hiracoins>1) {game.style.backgroundColor = "#ffc4ec"; credits.style.backgroundColor = "#ffc4ec"; hiracoins -= 1; switchCount++; update();} else { alert("You need more Hiracoins")}}
