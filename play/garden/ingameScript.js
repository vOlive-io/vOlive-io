...
var seeds = [
	...
	["Common Seeds", [
		["1.1.1.1", "Wheat", "Grows into unprocessed flower, a great start to a small garden!", 5, 1, 3, 2.00, 0, "soil", true, "Starter", 3],
		["1.1.1.2", "Grass", "Hard to take care of, but once you get the hang of it, you\'ll be swimming in it!", 5, 1, 3, 2.50, 0, "soil", true, "Starter", 0],
		["1.1.1.3", "Corn", "Time for a BBQ, with some corn-on-the-COB!", 0, 1, 3, 3.00, 0, "soil", false "Common", 0],
		["1.1.1.4", "Potato", "P-O-T-A-T-O that spells POTATO!", 0, 1, 3, 3.00, 0, "soil", false "Common", 0],
		["1.1.1.5", "Zucchini", "A thick cucumber-looking vegetable, that can make some tasty muffins, look it up.", 0, 1, 3, 3.50, 0, "soil", false "Common", 0],
		["1.1.1.6", "Cabbage (Green)", "A filling vegetable, that could probably only last me a day", 0, 1, 1, 4.00, 0, "soil", false "Common", 0],
		["1.1.1.7", "Cabbage (Purple)", "I always have some hand on taco night!", 0, 1, 1, 4.00, 0, "soil", false "Common", 0],
		["1.1.1.8", "Celery", "They say that it takes more calories to digest than gained by eating it.... ", 0, 1, 3, 3.00, 0, "soil", false "Common", 0],
		["1.1.1.9", "Cattail", "Very mess, but very pretty......", 0, 1, 3, 5.00, 0, "water", false "Common", 0],
		["1.1.1.10", "Mint", "A great and classic herb to grow, now don't let it get out of control.", 0, 1, 3, 3.00, 0, "soil", false "Common", 1],
		["1.1.1.11", "Fennel", "This reminds me of California trails, covered in fennel.", 0, 1, 3, 5.00, 0, "soil", false "Common", 1],
		["1.1.1.12", "Basil", "Now it's time for you to make some pesto!", 0, 1, 3, 5.00, 0, "soil", false "Common", 1],
		["1.1.1.13", "Carrot (Red)", "I never knew these were real until looking up different carrot varieties for this game.", 0, 1, 3, 4.00, 0, "soil", false "Common", 2],
		["1.1.1.14", "Carrot (Orange)", "Classic, never gets old..... until it does.", 0, 1, 3, 4.00, 0, "soil", false "Common", 2],
		["1.1.1.15", "Carrot (Purple)", "The coolest variety of a carrot ever!", 0, 1, 3, 4.00, 0, "soil", false "Common", 2],
		["1.1.1.16", "Carrot (White)", "This is a thing? What does it taste like, that's for you to find out!", 0, 1, 3, 4.00, 0, "soil", false "Common", 2],
		["1.1.1.17", "Radish", "If you pickle it, it tastes great with sushi.", 0, 1, 1, 6.00, 0, "soil", false "Common", 2],
		["1.1.1.18", "Oats", "A healthy replacement to cereal, but I doubt any of us care.", 0, 1, 3, 3.00, 0, "soil", false "Common", 3],
		["1.1.1.19", "Rice", "It might not look nice when harvested, but rest assured, when cooked or steamed right, you will get great food.", 0, 1, 3, 6.50, 0, "soil", false "Common", 3],
		["1.1.1.20", "Flowers", "Some random flowers you got at the store, you never know what kind of flowers they will grow....", 5, 1, 3, 2.00, 0, "soil", true, "Starter", 6],
		["1.1.1.21", "Rose", "Praised for the looks and smell, but......  I don't smell anything, but they look beautiful", 0, 4, 3, 10.00, 0, "soil", false "Common", 6],
		["1.1.1.22", "Sunflower", "A pretty flower to start your garden growing journey. Looks pretty and has great seeds.", 0, 2, 3, 7.50, 0, "soil", false "Common", 6]
	]],
	["Uncommon Seeds", [
		["1.1.2.1", "Bell Pepper (Red)", "Not all spicy, and it's a good food to add color to your diet.", 0, 2, 3, 7.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.2", "Bell Pepper (Orange)", "A bell pepper is the fruit of a flowering plant, a cultivar of Capsicum annuum. While used as a vegetable in culinary.........", 0, 2, 3, 7.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.3", "Bell Pepper (Yellow)", "The rainbow of bell pepper goes on, yellow is the best tasting one. (In my opinion)", 0, 2, 3, 7.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.4", "Bell Pepper (Green)", "The 'hardest' of the bell peppers having a slightly thicker crunch.", 0, 2, 3, 7.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.5", "Bell Pepper (Purple)", "Great color on a dress, great color on some food! ", 0, 2, 3, 8.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.6", "Tremella Mesenterica Mushroom", "The classic 'witch' mushroom! WITCH! WITCH! WITCH!", 0, 1, 3, 10.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.7", "Rhubarb", "My mom makes great strawberry and rhubarb pie..... hint hint", 0, 2, 3, 8.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.8", "Lettuce", "Seed Description", 0, 1, 3, 7.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.9", "Oyster Mushroom", "Seed Description", 0, 0.5, 3, 5.00, 0, "soil", false "Uncommon", 0],
		["1.1.2.10", "Camomile", "Seed Description", 0, 1, 3, 7.00, 0, "soil", false "Uncommon", 1],
		["1.1.2.11", "Sugar", "Seed Description", 0, 2, 3, 15.00, 0, "soil", false "Uncommon", 1],
		["1.1.2.12", "Lavender", "Seed Description", 0, 2, 3, 25.00, 0, "sand", false "Uncommon", 1],
		["1.1.2.13", "Nutmeg", "Seed Description", 0, 2, 3, 20.00, 0, "soil", false "Uncommon", 1],
		["1.1.2.14", "Parsley", "Seed Description", 0, 1, 3, 20.00, 0, "soil", false "Uncommon", 1],
		["1.1.2.15", "Garlic", "Seed Description", 0, 3, 3, 40.00, 0, "soil", false "Uncommon", 1],
		["1.1.2.16", "Onion (White)", "Seed Description", 0, 2, 3, 40.00, 0, "soil", false "Uncommon", 2],
		["1.1.2.17", "Onion (Purple)", "Seed Description", 0, 2, 3, 40.00, 0, "soil", false "Uncommon", 2],
		["1.1.2.18", "Avocado", "Seed Description", 0, 4, 3, 50.00, 0, "soil", false "Uncommon", 5],
		["1.1.2.19", "Red Apple", "Seed Description", 0, 4, 3, 50.00, 0, "soil", false "Uncommon", 5],
		["1.1.2.20", "Coral", "Seed Description", 0, 4, 3, 100.00, 0, "water", false "Uncommon", 6],
	]],
	["Rare Seeds", [
		["1.1.3.3", "Seaweed", "Seed Description", 0, 0, 3, 0.00, 0, "water", false "Rare", 1],
		["1.1.3.4", "Wasabi", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 2],
		["1.1.3.5", "Green Grapes", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.6", "Elderberry", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.7", "Strawberry", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.8", "Blueberry", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.9", "Blackberry", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.10", "Raspberry", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.12", "Acai", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.13", "Cranberry", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.14", "Watermelon", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.15", "Honeydew", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
		["1.1.3.16", "Cantolope", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Rare", 4],
	...
	["Epic Seeds", [
		...
		["1.1.4.3", "Vanilla", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 1],
		["1.1.4.4", "Green Apple", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 5],
		["1.1.4.5", "Black Diamond Apple", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 5],
		["1.1.4.6", "Maple", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 5],
		["1.1.4.7", "Mango", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 5],
		["1.1.4.8", "Cherry", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 5],
		["1.1.4.9", "Peach", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 5],
		["1.1.4.10", "Banana", "Seed Description", 0, 2, 3, 20.00, 0, "soil", false "Epic", 5],
		["1.1.4.11", "Cacao", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 6],
		["1.1.4.12", "Corpse Flower", "Seed Description", 0, 0, 3, 0.00, 0, "soil", false "Epic", 6]
	]],
	["Mythic Seeds", [
