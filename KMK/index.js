...
//  const characters = ['A duck', 'A cow', 'A sheep', 'A frog', 'A fart', 'A pigeon'];;
  const characters = ['Callie', 'Marrie', 'Agent 3', 'Agent 4', 'Agent 8', 'Captain 3', 'Craig Cuddlefish', 'Pearl', 'Pearl Drone' 'Marina', 'Acht', 'Shiver', 'Frye', 'Big Man', 'Murch', 'Mr. Coco', 'Harmoney', 'Shelldon', ' Jel La Fleur', 'Smallfry', 'Judd', 'Lil Judd', 'Mr. Grizz', 'Staff'];;
